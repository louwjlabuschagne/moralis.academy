...
contract MatiesCoin is Context, AccessControlEnumerable, ERC20Burnable, ERC20Pausable {
    ...
    event CapIncreased(uint256 cap);
    /**
    ...
    function increaseCap(uint amount) public returns (uint){
        require(hasRole(CAP_ROLE, _msgSender()), "ERC20Capped: must have cap role to increase cap");
        _cap = cap().add(amount);
